...
<!-- <div class="container-fluid">  -->
 ...
 <div class="container white" style="border-left: solid 1px #ddd;border-right: solid 1px #ddd;background-color: white;">
 			...
 			<div class="col-sm-3 resp" style="">        
			            ...
			            <a href="#" class="active badge ">Home</a>
		             	<a href="#" class="badge">Quotes</a>
		             	<a href="#" class="badge">Download </a>
		             	<a href="#" class="badge">Tutorial</a>
		             	<a href="#" class="badge">About</a>
...
<div class="container-fluid bg-white"  style="border-top: solid 1px #ddd; border-bottom: solid 1px #ddd;">
	<div class="container" style="margin-bottom: 20px">
		<div class="col-sm-4">
			<h3 style="color: grey"> New Articles </h3>
			<hr>
...
<div class="container-fluid bg-pat-1">
	<div class="container">
			...
			<div class="col-sm-12 text-center" style="margin-top: 15px; margin-bottom:15px;">
				<span style="color: grey"> <h5>2017-2022 &copy Copyright Allright Reserved, Ridread</h5></span>
			</div>	
	</div>
</div>
